...
module.exports = SassCompiler = (function() {
  ...
  SassCompiler.prototype.compile = function(data, path, callback) {
    var cmd, delay, error, execute, hasComments, result, _ref1, _ref2,
      _this = this;
    result = '';
    error = null;
    ...
    if (!this.brunchConfig.optimize) {
      hasComments = ((_ref1 = this.conf) != null ? _ref1.debug : void 0) === 'comments';
    ...
    if (((_ref2 = this.conf) != null ? _ref2.options : void 0) != null) {
