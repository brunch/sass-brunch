...
module.exports = SassCompiler = (function() {
  ...
  function SassCompiler(config) {
    var env, k, prefix, v, _ref1, _ref2, _ref3, _ref4,
      _this = this;
    this.config = config;
    ...
    this.bundler = (_ref3 = this.config.plugins) != null ? (_ref4 = _ref3.sass) != null ? _ref4.useBundler : void 0 : void 0;
    prefix = this.bundler ? 'bundle exec ' : '';
    exec("" + prefix + this._bin + " --version", this.mod_env, function(error, stdout, stderr) {
      if (error) {
        console.error("You need to have Sass on your system");
        return console.error("Execute `gem install sass`");
      }
    });
    exec("" + prefix + this._compass_bin + " --version", this.mod_env, function(error, stdout, stderr) {
  ...
  SassCompiler.prototype.compile = function(data, path, callback) {
    ...
    result = '';
    error = null;
    cmd = ['sass', '--stdin', '--load-path', this.config.paths.root, '--load-path', sysPath.dirname(path), '--no-cache'];
    if (this.bundler) {
    ...
    if (((_ref3 = this.config.plugins) != null ? (_ref4 = _ref3.sass) != null ? _ref4.options : void 0 : void 0) != null) {
      cmd.push.apply(cmd, this.config.plugins.sass.options);
    }
    execute = function() {
      var onExit, sass;
