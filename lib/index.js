...
module.exports = SassCompiler = (function() {
  ...
  function SassCompiler(config) {
    var env, k, v, _ref2, _ref3,
      _this = this;
    this.config = config;
    this.gem_home = (_ref2 = this.config.plugins) != null ? (_ref3 = _ref2.sass) != null ? _ref3.gem_home : void 0 : void 0;
    this.mod_env = {};
    if (this.gem_home) {
      env = ((function() {
        var _ref4, _results;
  ...
  SassCompiler.prototype.compile = function(data, path, callback) {
    var delay, error, execute, hasComments, options, result, _ref2, _ref3, _ref4, _ref5,
      _this = this;
    result = '';
    error = null;
    options = ['--stdin', '--load-path', this.config.paths.root, '--load-path', sysPath.dirname(path), '--no-cache'];
    if (!this.config.optimize) {
      hasComments = ((_ref2 = this.config.plugins) != null ? (_ref3 = _ref2.sass) != null ? _ref3.debug : void 0 : void 0) === 'comments';
      options.push((hasComments ? '--line-comments' : '--debug-info'));
    }
    if (((_ref4 = this.config.plugins) != null ? (_ref5 = _ref4.sass) != null ? _ref5.options : void 0 : void 0) != null) {
      options.push.apply(options, this.config.plugins.sass.options);
    }
    if (/\.scss$/.test(path)) options.push('--scss');
    execute = function() {
      var onExit, sass;
      if (_this.compass) options.push('--compass');
